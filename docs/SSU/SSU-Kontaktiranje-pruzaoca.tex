...
\begin{document}
	...
	\section{Scenario \genitivfunkcionalnosti}
		\subsection{Kratak opis}
			Ukoliko je korisnik prijavljen, može kontaktirati pružaoca usluge putem dijaloga na njegovom profilu. Postlate poruke se prosleduju pružaocu usluge na njegovu email adresu.
		\newpage
