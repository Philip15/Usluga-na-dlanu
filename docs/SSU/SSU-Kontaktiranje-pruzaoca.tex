	...
	\begin{center}
		\section*{Istorija izmena}
			\begin{tabular}{ |l|l|l|l| }
				...
				\hline
				10.06.2022. & 1.2  & Izmene pri implementaciji & \inicijalniautor, Jana Pašajlić \\
				\hline
				&  &  &  \\
				\hline
			\end{tabular}
		...
		\subsection{Tok događaja}
			\paragraph*{Osnovni uspešni scenario}
				\begin{enumerate}
					...
					\item Korisnik bira opciju za slanje mejla.
					\item Korisnik se prebacuje na stranicu za slanje mejla.
				\end{enumerate}
